...
export class InputSystem extends System {
  ...
  init(gpu) {
    ...
    gpu.canvas.addEventListener('pointerenter', this.pointerEnterCallback);
    gpu.canvas.addEventListener('pointerdown', this.pointerDownCallback);
    gpu.canvas.addEventListener('pointermove', this.pointerMoveCallback);
    gpu.canvas.addEventListener('pointerup', this.pointerUpCallback);
    gpu.canvas.addEventListener('mousewheel', this.mousewheelCallback);
  }
