...
export class StageSystem extends System {
  ...
  init(gpu, gltfLoader) {
    ...
    gltfLoader.fromUrl('../../../../assets/spookyball/models/graveyard-compressed.glb').then(scene => {
    ...
    gltfLoader.fromUrl('../../../../assets/spookyball/models/crow-compressed.glb').then(scene => {
