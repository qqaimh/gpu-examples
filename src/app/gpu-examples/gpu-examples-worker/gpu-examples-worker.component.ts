...
@Component({
  selector: 'gpu-examples-gpu-examples-worker',
  templateUrl: './gpu-examples-worker.component.html',
  styleUrls: ['./gpu-examples-worker.component.scss']
})
export class GpuExamplesWorkerComponent implements OnInit {
  ...
  async draw() {
    ...
    try {
      ...
      offscreenCanvas.width = this.theCanvas.nativeElement.clientWidth * devicePixelRatio;
      offscreenCanvas.height = this.theCanvas.nativeElement.clientHeight * devicePixelRatio;
