...
@Component({
  selector: 'app-gpu-examples-particles',
  templateUrl: './gpu-examples-particles.component.html',
  styleUrls: ['./gpu-examples-particles.component.scss']
})
export class GpuExamplesParticlesComponent implements OnInit {
