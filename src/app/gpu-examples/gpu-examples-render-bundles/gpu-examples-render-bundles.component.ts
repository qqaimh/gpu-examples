...
@Component({
  selector: 'gpu-examples-gpu-examples-render-bundles',
  templateUrl: './gpu-examples-render-bundles.component.html',
  styleUrls: ['./gpu-examples-render-bundles.component.scss']
})
export class GpuExamplesRenderBundlesComponent implements OnInit {
  ...
  async draw() {
    ...
    this.gui.add(settings, 'useRenderBundles');
    this.gui.add(settings, 'asteroidCount', 1000, 10000, 1000).onChange(() => {
