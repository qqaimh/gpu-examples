...
@Component({
  selector: 'app-gpu-examples-deferred-rendering',
  templateUrl: './gpu-examples-deferred-rendering.component.html',
  styleUrls: ['./gpu-examples-deferred-rendering.component.scss']
})
export class GpuExamplesDeferredRenderingComponent implements OnInit {
  ...
  const gBuffersDebugViewPipeline = device.createRenderPipeline({
    ...
    fragment: {
      ...
      constants: {
        canvasSizeWidth: this.theCanvas.nativeElement.width,
        canvasSizeHeight: this.theCanvas.nativeElement.height,
      },
    },
    primitive,
  });
  ...
  this.gui.add(settings, 'mode', ['rendering', 'gBuffers view']);
  this.gui.add(settings, 'numLights', 1, kMaxNumLights)
    .step(1)
    .onChange(() => {
