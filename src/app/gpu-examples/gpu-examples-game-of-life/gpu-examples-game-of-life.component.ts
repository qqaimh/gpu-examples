...
@Component({
  selector: 'gpu-examples-gpu-examples-game-of-life',
  templateUrl: './gpu-examples-game-of-life.component.html',
  styleUrls: ['./gpu-examples-game-of-life.component.scss']
})
export class GpuExamplesGameOfLifeComponent implements OnInit {
  ...
  async draw() {
    ...
    const addGUI = () => {
      this.gui.add(GameOptions, 'timestep', 1, 60, 1);
      this.gui.add(GameOptions, 'width', 16, 1024, 16).onFinishChange(resetGameData);
      this.gui.add(GameOptions, 'height', 16, 1024, 16).onFinishChange(resetGameData);
      this.gui
